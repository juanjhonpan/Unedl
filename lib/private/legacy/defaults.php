...
class OC_Defaults {
	...
	public function __construct() {
		...
		$this->defaultEntity = 'UNEDL'; /* e.g. company name, used for footers and copyright notices */
		$this->defaultName = 'UNEDL'; /* short name, used when referring to the software */
		$this->defaultTitle = 'UNEDL'; /* can be a longer name, for titles */
		$this->defaultBaseUrl = 'https://www.unedl.edu.mx/portal/';
